...
argocd app create ${APP_NAME} --project default --sync-policy auto --repo https://github.com/raghudevopsb79/roboshop-helm --path chart --dest-namespace ${NAMESPACE} --dest-server //kubernetes.default.svc --values-literal-file env-${ENV}/${APP_NAME}.yaml
